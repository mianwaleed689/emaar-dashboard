...
/* The access model's assertions moved to scripts/test/org.test.mjs when Sales
   admin and Accounts were added. A second copy here had already drifted: it
   still claimed Accounts must not see a client's contact details, which is
   wrong about the job — a VAT invoice is addressed to somebody. Asserted in
   one place now. */
