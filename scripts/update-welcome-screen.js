...
/*
  DXB ANALYTICS — WELCOME SCREEN
  Session 12 — First login only
...
export default function WelcomeScreen({ userName, orgName, managerName, userId, onDismiss }) {
  ...
  const TIPS = [
    ...
    },
    {
      ...
      body: "Use the Call button to dial directly. After every call, add a note in the Activity tab — your manager can see your progress in real time.",
    },
  ];
...
fs.writeFileSync("src/components/WelcomeScreen.jsx", code, "utf8");
console.log("WelcomeScreen.jsx updated with WA + Email + Call tips");