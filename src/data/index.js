/* â”€â”€â”€ DXB ANALYTICS â€” MASTER DATA FILE â”€â”€â”€ */
/* Source: Emaar THE BEAST Excel + DLD + DXBinteract + Yahoo Finance */

// S16: T theme lives in src/theme.js â€” single source of truth
...
/* â”€â”€â”€ 48 EMAAR PROJECTS (from Excel) â”€â”€â”€ */
export const emaarProjects = [
  // â”€â”€ STRUCTURE REFERENCE â€” 3 projects â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  // Add real projects via Admin â†’ Data Manager
  ...
  { id:1, name:"The Golf Residence", community:"Dubai Hills Estate", district:"DHE", type:"Apartments", beds:"1-3", status:"Under Construction", handover:"Q2 2026", price:1750000, sizeFrom:750, sizeTo:2200, ppsf:2333, payment:"20/30/50", construction:90, branded:false, brand:"â€”", tier:"Mid-Premium", emaarUrl:"https://www.propertyfinder.ae/en/new-projects/emaar-properties/the-golf-residence" },
  { id:2, name:"Hills Park",         community:"Dubai Hills Estate", district:"DHE", type:"Apartments", beds:"1-3", status:"Under Construction", handover:"Q2 2026", price:1210000, sizeFrom:650, sizeTo:1800, ppsf:1862, payment:"80/20",      construction:85, branded:false, brand:"â€”", tier:"Mid-Market",  emaarUrl:"https://www.propertyfinder.ae/en/new-projects/emaar-properties/hills-park" },
  { id:3, name:"Golf Grand",         community:"Dubai Hills Estate", district:"DHE", type:"Apartments", beds:"1-3", status:"Under Construction", handover:"Q1 2027", price:1529388, sizeFrom:700, sizeTo:2100, ppsf:2185, payment:"10/80/10",  construction:96, branded:false, brand:"â€”", tier:"Mid-Premium", emaarUrl:"https://www.propertyfinder.ae/en/new-projects/emaar-properties/golf-grand" },
];

/* â”€â”€â”€ ENHANCED FINANCIALS (from Excel PBI_Financials) â”€â”€â”€ */
...
/* â”€â”€â”€ COMMUNITIES (from Excel PBI_Communities) â”€â”€â”€ */
...
/* â”€â”€â”€ ENHANCED YIELDS (from Excel PBI_RentalYields) â”€â”€â”€ */
export const emaarYields = [
  { community:"Dubai Hills Estate", unit:"1BR Apt", rent:0, price:0, gross:0, net:0, demand:"Very High", tenant:"Professionals, couples", visa:"Yes (â‰¥2M)" },
  { community:"Dubai Hills Estate", unit:"2BR Apt", rent:0, price:0, gross:0, net:0, demand:"Very High", tenant:"Families, professionals", visa:"Yes (â‰¥2M)" },
  { community:"Dubai Hills Estate", unit:"3BR Apt", rent:0, price:0, gross:0, net:0, demand:"High", tenant:"HNW families", visa:"Yes (â‰¥2M)" },
  { community:"Dubai Creek Harbour", unit:"1BR Apt", rent:0, price:0, gross:0, net:0, demand:"High", tenant:"Young professionals", visa:"Yes (â‰¥2M)" },
  { community:"Dubai Creek Harbour", unit:"2BR Apt", rent:0, price:0, gross:0, net:0, demand:"High", tenant:"Expat families", visa:"Yes (â‰¥2M)" },
  { community:"Dubai Creek Harbour", unit:"3BR Apt", rent:0, price:0, gross:0, net:0, demand:"Moderate-High", tenant:"HNW tenants", visa:"Yes (â‰¥2M)" },
  { community:"Emaar Beachfront", unit:"1BR Apt", rent:0, price:0, gross:0, net:0, demand:"Very High", tenant:"Luxury expats", visa:"Yes (â‰¥2M)" },
  { community:"Emaar Beachfront", unit:"2BR Apt", rent:0, price:0, gross:0, net:0, demand:"High", tenant:"UHNW tenants", visa:"Yes (â‰¥2M)" },
  ...
  { community:"Emaar South", unit:"2BR Apt", rent:0, price:0, gross:0, net:0, demand:"Growing", tenant:"Families, value seekers", visa:"Yes (â‰¥2M)" },
  { community:"The Valley", unit:"3BR TH", rent:0, price:0, gross:0, net:0, demand:"High", tenant:"Family end-users", visa:"Yes (â‰¥2M)" },
  { community:"The Valley", unit:"4BR Villa", rent:0, price:0, gross:0, net:0, demand:"High", tenant:"Large families", visa:"Yes (â‰¥2M)" },
  { community:"Rashid Marina", unit:"1BR Apt", rent:0, price:0, gross:0, net:0, demand:"Moderate-High", tenant:"Maritime lifestyle", visa:"Yes (â‰¥2M)" },
  { community:"Downtown Dubai", unit:"1BR Apt", rent:0, price:0, gross:0, net:0, demand:"Very High", tenant:"Tourists, executives", visa:"Yes (â‰¥2M)" },
  { community:"Downtown Dubai", unit:"2BR Apt", rent:0, price:0, gross:0, net:0, demand:"Very High", tenant:"UHNW, corp. housing", visa:"Yes (â‰¥2M)" },
  { community:"Business Bay", unit:"1BR Apt", rent:0, price:0, gross:0, net:0, demand:"Very High", tenant:"Professionals, executives", visa:"Yes (â‰¥2M)" },
  { community:"Grand Polo Club", unit:"3BR TH", rent:0, price:0, gross:0, net:0, demand:"High", tenant:"HNW families, expats", visa:"Yes (â‰¥2M)" },
];

/* â”€â”€â”€ PROJECT ROI DATA BY COMMUNITY (Research-backed: DLD, Bayut, REIDIN, Knight Frank, JLL, Engel & VÃ¶lkers, Chestertons, BetterHomes Q4 2025) â”€â”€â”€ */
export const communityROI = {};

/* â”€â”€â”€ COMMUNITY MAP COORDINATES (Google Maps verified) â”€â”€â”€ */
...
export const dubaiLandmarks = [
  { name: "Burj Khalifa", lat: 25.1972, lng: 55.2744, icon: "â–²" },
  { name: "Palm Jumeirah", lat: 25.1124, lng: 55.1390, icon: "ðŸŒ´" },
  { name: "DXB Airport", lat: 25.2532, lng: 55.3657, icon: "âœˆ" },
  { name: "Al Maktoum Airport", lat: 24.8967, lng: 55.1614, icon: "âœˆ" },
  { name: "Dubai Marina", lat: 25.0800, lng: 55.1400, icon: "âš“" },
  { name: "Dubai Mall", lat: 25.1985, lng: 55.2796, icon: "ðŸ¬" },
];

/* â”€â”€â”€ TOP 10 DEVELOPERS (from Excel PBI_Developers) â”€â”€â”€ */
export const topDevelopers = [
  ...
  { rank:2, name:"DAMAC Properties", sales:35.9, salesUSD:9.8, units:15393, delivered:2113, underConst:46554, segment:"Mid-Premium â†’ Ultra-Lux", confidence:"VERIFIED", share:5.26, color:T.teal },
  { rank:3, name:"Binghatti", sales:26.0, salesUSD:7.1, units:17061, delivered:4093, underConst:38000, segment:"Affordable â†’ Mid-Premium", confidence:"VERIFIED", share:3.81, color:T.blue },
  ...
  { rank:5, name:"Sobha Realty", sales:22.4, salesUSD:6.1, units:9698, delivered:2260, underConst:26933, segment:"Premium â†’ Ultra-Lux", confidence:"VERIFIED", share:3.28, color:T.purple },
...
/* â”€â”€â”€ RISK MATRIX (from Excel PBI_Risks) â”€â”€â”€ */
...
/* â”€â”€â”€ DUBAI MARKET 2025 (from Excel PBI_DubaiMarket) â”€â”€â”€ */
...
/* â”€â”€â”€ ROI PHASES (from Excel PBI_ROIPhases) â”€â”€â”€ */
...
export const megaProjects = [
  { name:"Dubai Square", community:"Dubai Creek Harbour", value:"AED 180B+", scale:"2.6M sqm retail/hospitality", type:"Retail + Mixed-Use", timeline:"Phased 2028+", feature:"World's first drive-through mall", status:"Under Construction", developer:"Emaar Properties", announced:"Dec 2025",
    ...
    investorImpact:"Transforms Creek Harbour into a competing retail hub to Downtown Dubai. DCH avg PPSF currently AED 2,470 across 4,280 sales vs Downtown's AED 3,000 â€” a 17% gap that is expected to narrow as Dubai Square opens. Early DCH investors could see 8-12% annual capital appreciation.",
    completion:"Construction started late 2025. Phase 1 targeted for 2028. Full completion expected 2030-2032.",
    benchmark:"Hudson Yards (NYC): $25B over 1.2M sqm â€” Dubai Square is 2x the scale at 2.6M sqm. Battersea Power Station (London): Â£9B over 42 acres â€” Dubai Square spans 10x the area.",
    priceImpact:"DCH prices up 3% YoY with avg AED 2,470/sqft. Downtown Dubai (mature comparator) at AED 3,000/sqft â€” 17% premium gap expected to narrow as Dubai Square delivers.",
    milestones:["Nov 2025 â€“ Alabbar announces on Instagram","Dec 2025 â€“ Official Emaar press release","Q1 2026 â€“ Construction underway","2028 â€“ Phase 1 targeted opening","2030-2032 â€“ Full completion"],
  ...
  { name:"Dubai Mall Expansion", community:"Downtown Dubai", value:"AED 1.5B", scale:"279 new outlets across 12.1M sqft", type:"Retail Expansion", timeline:"2025-2027", feature:"World's most visited (111M/yr)", status:"Partially Open", developer:"Emaar Malls", announced:"Jun 2024",
    ...
    investorImpact:"Reinforces Downtown Dubai as the global retail capital. Drives foot traffic and rental demand for surrounding residential. For context: Mall of the Emirates announced AED 5B makeover with 100 new stores including Primark and Skims â€” Dubai Mall's expansion is defensive and offensive.",
    completion:"The District section opened March 2025. Exhibition centre operational early 2026. Remaining phases through 2027.",
    benchmark:"Mall of America (USA): 40M visitors/yr â€” Dubai Mall does 111M (2.8x). Westfield London: 27M sqft â€” Dubai Mall at 12.1M sqft but higher revenue per sqft due to tourism.",
    ...
    milestones:["Jun 2024 â€“ Expansion announced","Mar 2025 â€“ The District opens (65 outlets)","Early 2026 â€“ Exhibition centre operational","2027 â€“ Full expansion complete"],
  ...
  { name:"Dubai Creek Tower", community:"Dubai Creek Harbour", value:"AED 3.67B+", scale:"Iconic observation tower", type:"Mixed-Use Tower", timeline:"Tender Q1 2026", feature:"Calatrava-designed landmark", status:"Tender Phase", developer:"Emaar Properties", announced:"Jan 2026 Revival",
    desc:"Dubai Creek Tower is Emaar's iconic supertall tower designed by Santiago Calatrava, inspired by traditional minaret architecture. Originally announced in 2016 with foundations completed by 2018, work was halted during COVID. In January 2026, Mohamed Alabbar confirmed the project is back on track at the Dubai International Project Management Forum. The 2026 redesign shifts from height competition to architectural beauty â€” a 'modern minaret' rather than a record-breaker.",
    keyFacts:["AED 3.67B+ estimated investment","Santiago Calatrava iconic design","Redesigned as 'modern minaret' â€” beauty over height","Foundation completed 2016-2018 (already built)","Construction tender issued Q1 2026","Observation decks, sky gardens, hospitality","Centrepiece of Dubai Creek Harbour district","Integrated with Dubai Square mega retail"],
    ...
    milestones:["2016 â€“ Original announcement & groundbreaking","2018 â€“ Foundation completed","Apr 2020 â€“ Formally suspended (COVID)","Jan 2026 â€“ Alabbar confirms revival at DIPMF","Q1 2026 â€“ Construction tender issued","TBD â€“ Contractor selection & construction start"],
  ...
  { name:"The Oasis", community:"Dubailand", value:"AED 73B", scale:"100M sqft with 7,000+ villas", type:"Ultra-Luxury Villas", timeline:"2026-2032", feature:"Largest villa project globally", status:"Under Construction", developer:"Emaar Properties", announced:"2023 (expanded 2025)",
    ...
    investorImpact:"Targets UHNW segment with zero comparable competition at this scale. Avg sale price AED 17.6M (+3.84% YoY). Asking prices up 10% in 6 months. Entry at AED 8M+ ensures Golden Visa eligibility. Wade Adams appointed as contractor â€” construction is real. Near Al Maktoum Airport growth corridor.",
    ...
    benchmark:"Palm Jumeirah villas: AED 3,000-5,000/sqft (mature). Emirates Hills: AED 2,500-4,000/sqft. The Oasis at AED 1,800-2,000/sqft offers 40-50% discount to mature luxury â€” massive appreciation runway.",
    ...
    milestones:["Jun 2023 â€“ Gala launch at Armani Hotel, Burj Khalifa","2024 â€“ Palmiera Phase 2 & 3 launched","Dec 2025 â€“ Lavita & Address Villas Tierra launched","2025 â€“ Wade Adams appointed (infrastructure)","Q4 2027 â€“ Palmiera Phase 1 handover","2028-2032 â€“ Phased delivery continues"],
  ...
  { name:"Grand Polo Club", community:"Grand Polo Club", value:"AED 41B", scale:"60M sqft with 6,661 residences", type:"Luxury Lifestyle", timeline:"2026-2030", feature:"World's first polo-themed community", status:"Under Construction", developer:"Emaar Properties", announced:"Apr 2025",
    ...
    benchmark:"Royal County of Berkshire (UK polo): Â£5M-20M homes but no integrated community. Argentine Polo Club: private but no residential. Grand Polo Club is the world's first fully integrated polo-residential community at scale.",
    ...
    milestones:["Apr 2025 â€“ EOI bookings open, Selvara Phase 1","Mid 2025 â€“ Equestra, Equiterra, Equiterra 2 launched","Late 2025 â€“ Selvara 3 & 4, Chevalia Estate 2","2026 â€“ Infrastructure construction active","Jun 2029 â€“ First handovers targeted"],
  ...
  { name:"Emaar Hills", community:"Emaar Hills", value:"AED 100B", scale:"40,000 residences", type:"Mixed-Use Community", timeline:"2025-2035", feature:"Next-generation master community", status:"Under Construction", developer:"Emaar Properties", announced:"Oct 2025",
    ...
    milestones:["Oct 2025 â€“ Emaar Hills & Dubai Mansions announced","Oct 2025 â€“ Alabbar unveils at launch event","Late 2025 â€“ EOI & first sales phase","2026 â€“ Infrastructure construction","2027-2035 â€“ Phased residential delivery"],
  ...
  { name:"Dubai Creek Harbour District", community:"Dubai Creek Harbour", value:"AED 180B", scale:"11M sqm with 17,800+ units", type:"Master Community", timeline:"2020-2029", feature:"Metro Blue Line connected by 2029", status:"Under Construction", developer:"Emaar Properties", announced:"2015 (ongoing)",
    ...
    investorImpact:"Most mature mega-project with proven delivery. Metro Blue Line by 2029 is the biggest catalyst â€” historically, metro connectivity drives 15-25% value uplift in Dubai. At AED 2,470/sqft vs Downtown's AED 3,000, DCH offers 17% discount with convergence potential. Combined Creek Tower + Dubai Square + Metro = triple catalyst for price appreciation.",
    ...
    benchmark:"Downtown Dubai: AED 3,000/sqft, 4,033 sales. DCH at AED 2,470/sqft with 4,280 sales â€” already matching Downtown in transaction volume but at 17% lower prices. Canary Wharf (London) analogy: secondary CBD that eventually rivalled the City.",
    ...
    milestones:["2015 â€“ DCH masterplan announced","2020 â€“ First residential handovers","Sep 2025 â€“ 10,582 units completed (Emaar report)","Dec 2025 â€“ Dubai Square construction begins","Jan 2026 â€“ Creek Tower revival confirmed","2029 â€“ Metro Blue Line operational target"],
  ...
  { name:"Al Maktoum Airport Expansion", community:"Dubai South", value:"AED 128B", scale:"5 runways, 260M passengers", type:"Infrastructure", timeline:"Phase 1: 2032", feature:"World's largest airport", status:"Under Construction", developer:"Dubai Government / DAEP", announced:"Apr 2024",
    ...
    investorImpact:"Game-changer for all Dubai South properties. Emaar South, Grand Polo Club, and The Oasis sit directly in the growth corridor. Historical precedent: Areas near DXB (Deira, Bur Dubai) saw 200%+ appreciation over 20 years. Al Maktoum will support 1 million jobs and housing in Dubai South. Dubai South land values are among the lowest in Dubai â€” maximum upside potential.",
    ...
    benchmark:"King Salman Airport (Riyadh): competing for 'world's largest' title. Changi T5 (Singapore): $10B for 50M passengers. Al Maktoum at $35B for 260M passengers â€” 5x the scale of Changi T5 expansion.",
    ...
    milestones:["Apr 2024 â€“ Sheikh Mohammed approves AED 128B expansion","May 2025 â€“ AED 1B runway 2 contract to Binladin Group","May 2025 â€“ Tristar E&C enabling works underway","Mid 2025 â€“ Terminal substructure tenders issued","2026 â€“ APM & baggage system tenders expected","2032 â€“ Phase 1 operational (150M passengers)","2035+ â€“ Full capacity (260M passengers)"],
    sources:"DAEP Official, Gulf News (Dec 2025), Aviation Business ME, MEED, Newsweek, FTI Consulting"
  },
];

/* â”€â”€â”€ COMMUNITY INTELLIGENCE (Location Profiles) â”€â”€â”€ */
