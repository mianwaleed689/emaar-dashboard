...
export const emaarYields = [
  { community:"Dubai Hills Estate", unit:"1BR Apt", rent:0, price:0, gross:0, net:0, demand:"Very High", tenant:"Professionals, couples", visa:"Yes (02M)" },
  { community:"Dubai Hills Estate", unit:"2BR Apt", rent:0, price:0, gross:0, net:0, demand:"Very High", tenant:"Families, professionals", visa:"Yes (02M)" },
  { community:"Dubai Hills Estate", unit:"3BR Apt", rent:0, price:0, gross:0, net:0, demand:"High", tenant:"HNW families", visa:"Yes (02M)" },
  { community:"Dubai Creek Harbour", unit:"1BR Apt", rent:0, price:0, gross:0, net:0, demand:"High", tenant:"Young professionals", visa:"Yes (02M)" },
  { community:"Dubai Creek Harbour", unit:"2BR Apt", rent:0, price:0, gross:0, net:0, demand:"High", tenant:"Expat families", visa:"Yes (02M)" },
  { community:"Dubai Creek Harbour", unit:"3BR Apt", rent:0, price:0, gross:0, net:0, demand:"Moderate-High", tenant:"HNW tenants", visa:"Yes (02M)" },
  { community:"Emaar Beachfront", unit:"1BR Apt", rent:0, price:0, gross:0, net:0, demand:"Very High", tenant:"Luxury expats", visa:"Yes (02M)" },
  { community:"Emaar Beachfront", unit:"2BR Apt", rent:0, price:0, gross:0, net:0, demand:"High", tenant:"UHNW tenants", visa:"Yes (02M)" },
  ...
  { community:"Emaar South", unit:"2BR Apt", rent:0, price:0, gross:0, net:0, demand:"Growing", tenant:"Families, value seekers", visa:"Yes (02M)" },
  { community:"The Valley", unit:"3BR TH", rent:0, price:0, gross:0, net:0, demand:"High", tenant:"Family end-users", visa:"Yes (02M)" },
  { community:"The Valley", unit:"4BR Villa", rent:0, price:0, gross:0, net:0, demand:"High", tenant:"Large families", visa:"Yes (02M)" },
  { community:"Rashid Marina", unit:"1BR Apt", rent:0, price:0, gross:0, net:0, demand:"Moderate-High", tenant:"Maritime lifestyle", visa:"Yes (02M)" },
  { community:"Downtown Dubai", unit:"1BR Apt", rent:0, price:0, gross:0, net:0, demand:"Very High", tenant:"Tourists, executives", visa:"Yes (02M)" },
  { community:"Downtown Dubai", unit:"2BR Apt", rent:0, price:0, gross:0, net:0, demand:"Very High", tenant:"UHNW, corp. housing", visa:"Yes (02M)" },
  { community:"Business Bay", unit:"1BR Apt", rent:0, price:0, gross:0, net:0, demand:"Very High", tenant:"Professionals, executives", visa:"Yes (02M)" },
  { community:"Grand Polo Club", unit:"3BR TH", rent:0, price:0, gross:0, net:0, demand:"High", tenant:"HNW families, expats", visa:"Yes (02M)" },
];
...
export const dubaiLandmarks = [
  { name: "Burj Khalifa", lat: 25.1972, lng: 55.2744, icon: "🏙️" },
  { name: "Palm Jumeirah", lat: 25.1124, lng: 55.1390, icon: "🌴" },
  { name: "DXB Airport", lat: 25.2532, lng: 55.3657, icon: "✈️" },
  { name: "Al Maktoum Airport", lat: 24.8967, lng: 55.1614, icon: "✈️" },
  { name: "Dubai Marina", lat: 25.0800, lng: 55.1400, icon: "🛥️" },
  { name: "Dubai Mall", lat: 25.1985, lng: 55.2796, icon: "🛍️" },
];
