                      ...
                      <div style={{
                        ...
                        <div style={{
                          ...
                          {[
                            ...
                            /* Icon-only, so it needs a name on hover — otherwise
                               the only way to learn what it does is to click it. */
                            <button key={v.k} type="button" onClick={() => setProjView(v.k)}
                              title={v.k === "grid" ? "Show each project as a card" : "Show all projects in one list"}
                              aria-label={v.k === "grid" ? "Card view" : "List view"}
                              style={{
                                padding:"7px 12px",
                ...
                {projDetailTab === "developer" && (() => {
                  ...
                  <div>
                    <div style={{ padding:"18px 20px", background:`linear-gradient(135deg, rgba(212,168,67,0.08), rgba(20,184,166,0.04))`, border:`1px solid ${T.border}`, borderRadius:14, marginBottom:16 }}>
                      ...
                      <div style={{ fontSize:22, fontWeight:800, color:T.white, fontFamily:"'Fraunces',serif", marginBottom:4 }}>{selectedProject.developerActual || selectedProject.developer || "—"}</div>
                    ...
                    {Array.isArray(selectedProject.developerFlagshipProjects) && selectedProject.developerFlagshipProjects.length > 0 && (
                      <div className="chart-box" style={{ padding:18, marginBottom:12 }}>
                        <div style={{ fontSize:12, fontWeight:700, color:T.white, marginBottom:12 }}>Flagship Projects by {selectedProject.developerActual || selectedProject.developer || selectedProject.developerName}</div>
                        <div style={{ display:"flex", flexWrap:"wrap", gap:6 }}>
