            ...
            return (
              <div style={{ animation:"fadeUp 0.4s ease-out forwards" }}>
                ...
                <div style={{
                  ...
                  {/* Configuration â€” HIDDEN when not applicable */}
                  ...
                  <div style={{ flex:"1 1 140px", minWidth:130 }}>
                    ...
                    <select
                      ...
                      <option value="1000000-2000000">AED 1M â€” 2M</option>
                      <option value="2000000-5000000">AED 2M â€” 5M</option>
                      <option value="5000000-10000000">AED 5M â€” 10M</option>
                ...
                {/* â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
                   MORE FILTERS PANEL â€” slides down when button clicked
                  ...
                  <div>
                    ...
                    <div className="chart-box" style={{ padding:20, marginBottom:16 }}>
                      ...
                      <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:12, fontSize:12, color:T.textSecondary, lineHeight:1.9 }}>
                        ...
                        <div><strong style={{ color:T.white }}>Build Progress:</strong> {selectedProject.constructionPct != null ? (selectedProject.constructionPct + "%" + (selectedProject.constructionPctIsEstimate ? " (est.)" : "")) : "â€”"}</div>
                      </div>
                    </div>
                    {(() => {
