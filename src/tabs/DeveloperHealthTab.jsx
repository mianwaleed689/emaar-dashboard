/* eslint-disable */
/* DEVELOPER HEALTH TAB ‚‚Ç¨‚Äù Developer scoring & financial health */
...
function DeveloperHealthTab({ liveNeighbourhoods=[],
  ...
  const dhMatchesGlobalFilter = (d) => {
    ...
    return rowName.includes(gfDev);
            ...
            /* ‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê
               DEVELOPER HEALTH ‚‚Ç¨‚Äù 9-Factor Scoring Model
               Sources: DLD transaction data, RERA registry,
               DXBinteract, Arabian Business, company disclosures
               
               9 Factors (total 100 pts):
               1. Sales Velocity       (15pts) ‚‚Ç¨‚Äù DLD monthly transactions
               2. Delivery Track Record(20pts) ‚‚Ç¨‚Äù on-time %, completed projects
               3. Financial Strength   (20pts) ‚‚Ç¨‚Äù revenue, cash, debt
               4. Project Pipeline     (10pts) ‚‚Ç¨‚Äù active launches, backlog
               5. Market Reputation    (10pts) ‚‚Ç¨‚Äù buyer reviews, complaints
               6. RERA Compliance      (10pts) ‚‚Ç¨‚Äù violations, escrow status
               7. DLD Transaction Rank (5pts)  ‚‚Ç¨‚Äù market share rank
               8. Pricing Stability    (5pts)  ‚‚Ç¨‚Äù PPSF consistency
               9. Buyer Nationality Mix(5pts)  ‚‚Ç¨‚Äù diversification
            ‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê */

            const HEALTH_SCORES = [
              /* ‚‚Äù‚Ç¨‚‚Äù‚Ç¨‚‚Äù‚Ç¨ TIER 1: MARKET LEADERS ‚‚Äù‚Ç¨‚‚Äù‚Ç¨‚‚Äù‚Ç¨ */
              {
                ...
                summary:"Undisputed market leader. Highest delivery rate. DFM listed ‚‚Ç¨‚Äù full transparency. 60+ active project launches in 2024.",
              },
              {
              ...
              /* ‚‚Äù‚Ç¨‚‚Äù‚Ç¨‚‚Äù‚Ç¨ TIER 2: STRONG PERFORMERS ‚‚Äù‚Ç¨‚‚Äù‚Ç¨‚‚Äù‚Ç¨ */
              {
              ...
              },
              {
                ...
                badges:["Fastest Growing","Iconic Architecture","60+ Projects","Bond Watch ‚ö†"],
                ...
                summary:"Fastest growing private developer. 2025 sales AED 26B ‚‚Ç¨‚Äù extraordinary growth. Bond stress signals Mar 2026 require monitoring.",
              },
              {
              ...
              /* ‚‚Äù‚Ç¨‚‚Äù‚Ç¨‚‚Äù‚Ç¨ TIER 3: MID-MARKET ‚‚Äù‚Ç¨‚‚Äù‚Ç¨‚‚Äù‚Ç¨ */
              {
              ...
              },
              {
                ...
                summary:"Mid-market affordable developer. JVC + Business Bay projects. Private ‚‚Ç¨‚Äù limited disclosures. Improving delivery consistency.",
              },
              {
            ...
            /* ‚‚Äù‚Ç¨‚‚Äù‚Ç¨ live data ‚Ü‚Äô seed swap ‚‚Äù‚Ç¨‚‚Äù‚Ç¨ */
            ...
            /* ‚‚Äù‚Ç¨‚‚Äù‚Ç¨ Filter + sort ‚‚Äù‚Ç¨‚‚Äù‚Ç¨ */
              ...
              <div style={{ animation:"fadeUp 0.4s ease-out forwards" }}>
                ...
                <div style={{ display:"flex", alignItems:"flex-start", justifyContent:"space-between", padding:"10px 0", marginBottom:16, borderBottom:`1px solid ${T.border}`, flexWrap:"wrap", gap:8 }}>
                  <div>
                    ...
                    <div style={{ fontSize:11, color:T.textMuted, marginTop:3 }}>9-factor scoring ¬∑ 15 developers ranked ¬∑ DLD + RERA + IR data ¬∑ {rawHealth === HEALTH_SCORES ? "Seed data ‚‚Ç¨‚Äù upload via Admin" : "Live Firestore data"}</div>
                  </div>
                  ...
                  <div style={{ background:T.surface, border:`1px solid ${T.border}`, borderRadius:12, overflow:"hidden", marginBottom:16 }}>
                    ...
                    {filtered.map((d,i)=>(
                      <div key={i}
                        ...
                        {/* Status arrow */}
                        <div style={{ fontSize:11, color:T.textMuted }}>View detail ‚Ü‚Äô</div>
                      </div>
                    ))}
                  </div>
                )}
