...
/* ‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê
   DXB ANALYTICS ‚‚Ç¨‚Äù CURRENCY TAB
...
/* ‚‚Äù‚Ç¨‚‚Äù‚Ç¨ Top currencies for Dubai international buyers (FALLBACK rates) ‚‚Äù‚Ç¨‚‚Äù‚Ç¨ */
const TOP_CURRENCIES = [
  { code: "USD", name: "US Dollar",        flag: "üá∫üá∏", rate: 3.6725, change: 0.0,   buyers: "Americas" },
  { code: "GBP", name: "British Pound",    flag: "üá¨üáß", rate: 4.6420, change: +0.8,  buyers: "UK" },
  { code: "EUR", name: "Euro",             flag: "üá™üá∫", rate: 3.9850, change: -0.3,  buyers: "Europe" },
  { code: "INR", name: "Indian Rupee",     flag: "üáÆüá≥", rate: 0.0441, change: -0.2,  buyers: "India ‚‚Ç¨‚Äù #1 buyer nation" },
  { code: "RUB", name: "Russian Ruble",    flag: "üá∑üá∫", rate: 0.0401, change: +1.2,  buyers: "Russia" },
  { code: "CNY", name: "Chinese Yuan",     flag: "üá®üá≥", rate: 0.5062, change: +0.1,  buyers: "China" },
  { code: "PKR", name: "Pakistani Rupee",  flag: "üáµüá∞", rate: 0.0131, change: -0.5,  buyers: "Pakistan" },
  { code: "SAR", name: "Saudi Riyal",      flag: "üá∏üá¶", rate: 0.9793, change: 0.0,   buyers: "GCC" },
  { code: "CHF", name: "Swiss Franc",      flag: "üá®üá≠", rate: 4.1380, change: +0.4,  buyers: "Europe" },
  { code: "CAD", name: "Canadian Dollar",  flag: "üá®üá¶", rate: 2.6840, change: -0.2,  buyers: "Canada" },
  { code: "AUD", name: "Australian Dollar",flag: "üá¶üá∫", rate: 2.3610, change: +0.3,  buyers: "Australia" },
  { code: "JPY", name: "Japanese Yen",     flag: "üáØüáµ", rate: 0.0245, change: -0.8,  buyers: "Japan" },
];

/* ‚‚Äù‚Ç¨‚‚Äù‚Ç¨ 12-month historical data (seed) ‚‚Äù‚Ç¨‚‚Äù‚Ç¨ */
const RATE_HISTORY = {
...
function CurrencyTab({ selectedCcy, setSelectedCcy, aedAmount, setAedAmount, searchCcy, setSearchCcy }) {
  /* ‚‚Äù‚Ç¨‚‚Äù‚Ç¨‚‚Äù‚Ç¨ LIVE RATES from exchangerate.host (free, UAE Central Bank source) ‚‚Äù‚Ç¨‚‚Äù‚Ç¨‚‚Äù‚Ç¨ */
  ...
  return (
    <div style={{ animation: "fadeUp 0.4s ease-out forwards" }}>
      ...
      <div style={{ background: "rgba(212,168,67,0.06)", border: "1px solid rgba(212,168,67,0.2)", borderRadius: 10, padding: "10px 16px", marginBottom: 20, display: "flex", alignItems: "center", gap: 10 }}>
        ...
        <span style={{ fontSize: 12, color: T.textSecondary }}><span style={{ color: T.gold, fontWeight: 700 }}>AED is pegged to USD at 3.6725</span> ‚‚Ç¨‚Äù fixed since 1997 by UAE Central Bank. AED/USD rate never changes. All other pairs fluctuate vs USD.</span>
      </div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1.6fr", gap: 16, marginBottom: 20 }}>
        ...
        <div className="chart-box" style={{ padding: 20 }}>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 4 }}>
            <div style={{ fontFamily: "'Fraunces', serif", fontSize: 14, fontWeight: 700, color: T.white }}>AED/{selectedCcy} ‚‚Ç¨‚Äù 12 Month Trend</div>
            <span style={{ fontSize: 10, color: T.textMuted }}>Apr 2025 ‚‚Ç¨‚Äú Apr 2026</span>
          </div>
