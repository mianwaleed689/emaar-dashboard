...
/* ‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê‚‚Ä¢ê
   DXB ANALYTICS ‚‚Ç¨‚Äù COMPLIANCE TAB
...
function ComplianceTab({ reraCard, setReraCard, reraCardLoading, setReraCardLoading, reraCardSaved, setReraCardSaved, waTemplate, setWaTemplate, firebaseUser, orgRole, userName }) {
            ...
            return (<>
              ...
              <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:16, alignItems:"start" }}>
                ...
                {/* ‚‚Äù‚Ç¨‚‚Äù‚Ç¨ Left column ‚‚Äù‚Ç¨‚‚Äù‚Ç¨ */}
                        ...
                        <div>
                          ...
                          {daysLeft !== null && (
                            <div style={{ fontSize:11, color:T.textMuted, marginTop:2 }}>
                              {daysLeft <= 0 ? "Your RERA card has expired ‚‚Ç¨‚Äù renew immediately" : `${daysLeft} days remaining until expiry`}
                            </div>
                          )}
                        </div>
                      </div>
                ...
                {/* ‚‚Äù‚Ç¨‚‚Äù‚Ç¨ Right column ‚‚Äù‚Ç¨‚‚Äù‚Ç¨ */}
                <div style={{ display:"flex", flexDirection:"column", gap:16 }}>
                  ...
                  <div style={{ background:T.card, border:`1px solid ${T.border}`, borderRadius:14, padding:"16px 18px" }}>
                    ...
                    {[
                      { label:"RERA ‚‚Ç¨‚Äù Real Estate Regulatory Agency",   url:"https://www.dubailand.gov.ae/en/eservices/real-estate-broker-registration/" },
                      { label:"DLD ‚‚Ç¨‚Äù Dubai Land Department",            url:"https://dubailand.gov.ae"                },
                      { label:"Trakheesi ‚‚Ç¨‚Äù Permit System",              url:"https://www.dubailand.gov.ae/en/eservices/trakheesi/" },
                      { label:"DTCM ‚‚Ç¨‚Äù Holiday Home Permits",            url:"https://dtcm.gov.ae"                     },
                      { label:"ICP ‚‚Ç¨‚Äù Visa & Golden Visa",               url:"https://icp.gov.ae"                      },
                    ].map(({label,url},i)=>(
