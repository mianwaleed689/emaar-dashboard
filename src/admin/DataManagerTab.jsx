...
const COMMUNITIES = [
  {id:"DHE",name:"Dubai Hills Estate",      area:"New Dubai",     projects:0,avgPpsf:0,type:"Master Community"},
  {id:"DCH",name:"Dubai Creek Harbour",     area:"Old Dubai",     projects:0,avgPpsf:0,type:"Waterfront"},
  {id:"TV", name:"The Valley",              area:"Dubailand",     projects:0,avgPpsf:0,type:"Suburban Villas"},
  {id:"RYM",name:"Mina Rashid",             area:"Bur Dubai",     projects:0,avgPpsf:0,type:"Marina Heritage"},
  {id:"ES", name:"Emaar South",             area:"Dubai South",   projects:0,avgPpsf:0,type:"Golf & Airport"},
  {id:"AR3",name:"Arabian Ranches 3",       area:"Dubailand",     projects:0,avgPpsf:0,type:"Family Villas"},
  {id:"GPC",name:"Grand Polo Club & Resort",area:"DIP 2",         projects:0,avgPpsf:0,type:"Polo Lifestyle"},
  {id:"EBF",name:"Emaar Beachfront",        area:"Dubai Harbour", projects:0,avgPpsf:0,type:"Beachfront Island"},
  {id:"TO", name:"The Oasis",               area:"Dubailand",     projects:0,avgPpsf:0,type:"Ultra-Luxury Villas"},
  {id:"DT", name:"Downtown Dubai",          area:"Downtown",      projects:0, avgPpsf:0,type:"Iconic CBD"},
  {id:"TH", name:"The Heights CW",          area:"DIP Corridor",  projects:0, avgPpsf:0,type:"Wellness Community"},
  {id:"DM", name:"Dubai Marina",            area:"Marina",        projects:0, avgPpsf:0,type:"Waterfront"},
  {id:"EC", name:"Expo City",               area:"Dubai South",   projects:0, avgPpsf:0,type:"Expo Legacy"},
  {id:"ZB", name:"Zabeel",                  area:"Downtown",      projects:0, avgPpsf:0,type:"Urban Luxury"},
  {id:"BB", name:"Business Bay",            area:"CBD",           projects:0, avgPpsf:0,type:"CBD Mixed"},
];
...
function emptyP(p={}) {
  return {
    ...
    furnishing:p.furnishing||"Unfurnished", parking:p.parking||0,
    ...
    goldenVisa:p.goldenVisa||"Yes", liquidityScore:p.liquidityScore||0,
    // Market intelligence
    dldTxCount:p.dldTxCount||0, dldAvgResale:p.dldAvgResale||0,
    unitsTotal:p.unitsTotal||0, unitsSold:p.unitsSold||0,
    unitsAvailable:p.unitsAvailable||0, demandScore:p.demandScore||0,
    // Docs
...
function emptyC(d={}) {
  return {
    grossYield_apt1:d.grossYield?.apt1??0, grossYield_apt2:d.grossYield?.apt2??0,
    grossYield_apt3:d.grossYield?.apt3??0, grossYield_th:d.grossYield?.th??0,
    grossYield_villa:d.grossYield?.villa??0,
    netYield_apt1:d.netYield?.apt1??0,   netYield_apt2:d.netYield?.apt2??0,
    netYield_apt3:d.netYield?.apt3??0,   netYield_th:d.netYield?.th??0,
    netYield_villa:d.netYield?.villa??0,
    estRent_apt1:d.estRent?.apt1??0, estRent_apt2:d.estRent?.apt2??0,
    estRent_apt3:d.estRent?.apt3??0, estRent_th:d.estRent?.th??0,
    estRent_villa:d.estRent?.villa??0,
    appreciation5yr:d.appreciation5yr??0, appreciationYoY:d.appreciationYoY??0,
    occupancy:d.occupancy??0, avgDaysToLease:d.avgDaysToLease??0,
    shortTermPremium:d.shortTermPremium??0, riskLevel:d.riskLevel??"Low",
    serviceCharge:d.serviceCharge??0, transferFee:d.transferFee??0,
    agentCommission:d.agentCommission??0, goldenVisa:d.goldenVisa??"Yes",
