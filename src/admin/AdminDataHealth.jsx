/**
 * DXB Analytics ââ‚¬â€ S15: Admin Data Health Dashboard
 ...
 * - Market Data Editor ââ‚¬â€ admin updates globalMarket fields
 ...
 *
 * Iron Rule: NEVER run npx vercel --prod ââ‚¬â€ use git push only
 */
...
// ââ€â‚¬ââ€â‚¬ Cron feed definitions ââ‚¬â€ matches vercel.json schedules ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬
const CRON_FEEDS = [
  {
    id:        "eibor",
    name:      "EIBOR Rates",
    ...
    greenDays: 1,
    yellowDays:7,
    description: "CBUAE EIBOR rates (overnight â†â€™ 12M) ââ‚¬â€ 4-source waterfall",
  },
  {
    id:        "news",
    name:      "News Feed",
    ...
    greenDays: 1,
    yellowDays:3,
    description: "6 RSS sources ââ‚¬â€ Arabian Business, PropertyNews.ae, Gulf Business, Gulf News, The National, Khaleej Times",
  },
  {
    id:        "yields",
    name:      "Rental Yields",
    ...
    greenDays: 7,
    yellowDays:14,
    description: "Bayut API ââ‚¬â€ 11 Emaar communities Ãâ€” 4 unit types â†â€™ gross yield",
  },
  {
    id:        "financials",
    ...
    greenDays: 7,
    yellowDays:30,
    description: "Yahoo Finance ââ‚¬â€ EMAAR.AE + EMAARDEV.AE ââ‚¬â€ 4-method fallback",
  },
  {
    id:        "dld",
    ...
    greenDays: 1,
    yellowDays:7,
    description: "Dubai Pulse DLD API ââ‚¬â€ daily transactions â†â€™ communityData + marketData/global",
    pending:   true,
    pendingReason: "DLD API keys pending from dubaipulse.gov.ae",
  },
];

// ââ€â‚¬ââ€â‚¬ Global market fields for editor ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬
const GLOBAL_MARKET_FIELDS = [
  { key: "totalMarketValue",  label: "Total Market Value",  placeholder: "e.g. AED 682.5B",  hint: "DLD annual ââ‚¬â€ update Jan each year" },
  ...
  { key: "avgGrossYield",     label: "City Avg Gross Yield", placeholder: "e.g. 6.9",          hint: "REIDIN/Bayut ââ‚¬â€ monthly" },
...
// ââ€â‚¬ââ€â‚¬ Helpers ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬
...
// ââ€â‚¬ââ€â‚¬ Main Component ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬
export default function AdminDataHealth({ db, T }) {
  ...
  // ââ€â‚¬ââ€â‚¬ Load all feed statuses from Firestore ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬
  ...
  // ââ€â‚¬ââ€â‚¬ Load market global data ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬
  ...
  // ââ€â‚¬ââ€â‚¬ Live alerts from Firestore ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬
  useEffect(() => {
    loadFeedData();
    loadGlobalMarket();
  ...
  // ââ€â‚¬ââ€â‚¬ Force refresh a cron ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬
  const forceRefresh = async (feed) => {
    ...
    try {
      ...
      setSaveStatus(p => ({ ...p, [feed.id + "_refresh"]: json.ok ? "âœâ€¦ Refreshed" : "âš ï¸ Partial" }));
      setTimeout(() => setSaveStatus(p => ({ ...p, [feed.id + "_refresh"]: "" })), 4000);
    } catch (err) {
      setSaveStatus(p => ({ ...p, [feed.id + "_refresh"]: "âŒ Failed" }));
      setTimeout(() => setSaveStatus(p => ({ ...p, [feed.id + "_refresh"]: "" })), 4000);
    }
    setRefreshing(p => ({ ...p, [feed.id]: false }));
  };

  // ââ€â‚¬ââ€â‚¬ Save global market data ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬
  ...
  // ââ€â‚¬ââ€â‚¬ Pin/unpin news article ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬
  ...
  // ââ€â‚¬ââ€â‚¬ Mark alert as read ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬
  ...
  // ââ€â‚¬ââ€â‚¬ Styles ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬
  const S = {
    ...
    <div style={S.wrap}>
      ...
      <div style={{ marginBottom: 24 }}>
        ...
        <div style={{ fontSize: 13, color: "#64748B" }}>
          Nerve centre of the DXB Analytics live data platform ââ‚¬â€ feed statuses, market data editor, alert log.
        </div>
        {unreadAlerts.length > 0 && (
          <div style={{ marginTop: 12, padding: "8px 14px", background: "rgba(239,68,68,0.08)", border: "1px solid rgba(239,68,68,0.2)", borderRadius: 8, fontSize: 13, color: "#EF4444", fontWeight: 600 }}>
            âš ï¸ {unreadAlerts.length} unread alert{unreadAlerts.length > 1 ? "s" : ""}
          </div>
        )}
      </div>
      ...
      <div style={S.sectionNav}>
        {[
          { key: "feeds",    label: "ğŸâ€œ¡ Data Feeds" },
          { key: "market",   label: "âœï¸ Market Data Editor" },
          { key: "external", label: "ğŸâ€œ‹ ValuStrat / KF" },
          { key: "alerts",   label: `ğŸâ€â€ Alerts${unreadAlerts.length ? ` (${unreadAlerts.length})` : ""}` },
          { key: "news",     label: "ğŸâ€œ° News Pin/Unpin" },
        ].map(s => (
      ...
      {/* ââ€â‚¬ââ€â‚¬ SECTION: DATA FEEDS ââ€â‚¬ââ€â‚¬ */}
      {activeSection === "feeds" && (
        <div>
          <div style={S.sectionTitle}>Live Data Feeds ââ‚¬â€ {CRON_FEEDS.length} configured</div>
          {CRON_FEEDS.map(feed => {
                ...
                <div style={S.feedRow}>
                  ...
                  <div style={S.feedInfo}>
                    ...
                    <div style={S.feedMeta}>
                      ...
                      {data?.usedFallback && (
                        <span style={S.badge("#F59E0B")}>âš ï¸ Fallback used</span>
                      )}
                      {feed.pending && (
                        <span style={S.badge("#64748B")}>â³ {feed.pendingReason}</span>
                      )}
                    </div>
                    {data?.source && (
                    ...
                    {feed.id === "news" && data?.rows && (
                      <div style={{ fontSize: 11, color: "#94A3B8", marginTop: 4 }}>
                        {data.rows.length} articles Â· Top: {data.rows[0]?.headline?.slice(0, 60)}ââ‚¬¦
                      </div>
                    )}
                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: 6, alignItems: "flex-end" }}>
                    ...
                    >
                      {refreshing[feed.id] ? "â³ Runningââ‚¬¦" : feed.pending ? "â³ Pending" : "ââ€“¶ Refresh Now"}
                    </button>
          ...
          <div style={{ ...S.card, marginTop: 8 }}>
            <div style={{ fontSize: 13, fontWeight: 700, color: "#D4A843", marginBottom: 12 }}>ğŸâ€œâ€¦ Vercel Cron Schedule (UTC)</div>
      ...
      {/* ââ€â‚¬ââ€â‚¬ SECTION: MARKET DATA EDITOR ââ€â‚¬ââ€â‚¬ */}
      {activeSection === "market" && (
        <div>
          <div style={S.sectionTitle}>Market Data Editor ââ‚¬â€ marketData/global</div>
          <div style={{ ...S.card, marginBottom: 16 }}>
            <div style={{ fontSize: 12, color: "#64748B", marginBottom: 16, padding: "8px 12px", background: "rgba(212,168,67,0.06)", borderRadius: 8, borderLeft: "3px solid #D4A843" }}>
              â„¹ï¸ These fields are read by the Overview, Market, and DLD Volumes tabs. Update DLD figures annually (January), ValuStrat monthly, PPSF as needed.
            ...
            <div style={{ marginTop: 20, display: "flex", gap: 12, alignItems: "center" }}>
              ...
              >
                {saveStatus.global === "saving" ? "Savingââ‚¬¦" : saveStatus.global === "saved" ? "âœâ€¦ Saved to Firestore" : "ğŸâ€™¾ Save Market Data"}
              </button>
              <button
      ...
      {/* ââ€â‚¬ââ€â‚¬ SECTION: EXTERNAL REPORTS ââ€â‚¬ââ€â‚¬ */}
      {activeSection === "external" && (
        <div>
          <div style={S.sectionTitle}>External Report Data ââ‚¬â€ ValuStrat & Knight Frank</div>
          ...
          <div style={S.card}>
            <div style={{ fontSize: 14, fontWeight: 700, color: "#fff", marginBottom: 4 }}>
              ValuStrat VPI ââ‚¬â€ Monthly
            </div>
            <div style={{ fontSize: 12, color: "#64748B", marginBottom: 14 }}>
              Source: <a href="https://valustrat.com" target="_blank" rel="noopener noreferrer" style={{ color: "#D4A843" }}>valustrat.com</a> â†â€™ UAE Real Estate Reports â†â€™ Dubai Residential Capital Values
            </div>
            ...
            <div style={{ marginTop: 14, display: "flex", gap: 10, alignItems: "center" }}>
              <button style={S.saveBtn(saveStatus.valustrat)} onClick={() => saveGlobal(VALUSTRAT_FIELDS, editValuStrat, "valustrat")}>
                {saveStatus.valustrat === "saved" ? "âœâ€¦ Saved" : "ğŸâ€™¾ Save ValuStrat"}
              </button>
            </div>
          </div>
          ...
          <div style={S.card}>
            <div style={{ fontSize: 14, fontWeight: 700, color: "#fff", marginBottom: 4 }}>
              Knight Frank ââ‚¬â€ Quarterly
            </div>
            <div style={{ fontSize: 12, color: "#64748B", marginBottom: 14 }}>
              Source: <a href="https://knightfrank.ae" target="_blank" rel="noopener noreferrer" style={{ color: "#D4A843" }}>knightfrank.ae</a> â†â€™ Insights â†â€™ Dubai Residential Market Update
            </div>
            <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 12 }}>
            ...
            <div style={{ marginTop: 14 }}>
              <button style={S.saveBtn(saveStatus.kf)} onClick={() => saveGlobal(KNIGHT_FRANK_FIELDS, editKF, "kf")}>
                {saveStatus.kf === "saved" ? "âœâ€¦ Saved" : "ğŸâ€™¾ Save Knight Frank"}
              </button>
            </div>
          </div>
        </div>
      ...
      {/* ââ€â‚¬ââ€â‚¬ SECTION: ALERTS ââ€â‚¬ââ€â‚¬ */}
      {activeSection === "alerts" && (
        <div>
          <div style={S.sectionTitle}>Alert Log ââ‚¬â€ adminAlerts collection</div>
          {alerts.length === 0 && (
            <div style={{ ...S.card, textAlign: "center", color: "#64748B", padding: 40 }}>
              âœâ€¦ No alerts. All systems operational.
            </div>
          )}
          {alerts.map(alert => (
            <div key={alert.id} style={{
              ...
              <div style={{ fontSize: 20, flexShrink: 0 }}>
                {alert.severity === "error" ? "ğŸâ€´" : alert.severity === "warning" ? "ğŸŸ¡" : "ğŸŸ¢"}
              </div>
              <div style={{ flex: 1 }}>
                ...
                <div style={{ fontSize: 11, color: "#64748B" }}>
                  {alert.type} Â· {timeAgo(alert.createdAt)} Â· {alert.source}
                </div>
                {alert.data && (
                  <div style={{ fontSize: 11, color: "#64748B", marginTop: 4, fontFamily: "monospace" }}>
                    {JSON.stringify(alert.data).slice(0, 120)}ââ‚¬¦
                  </div>
                )}
              </div>
              {!alert.read && (
      ...
      {/* ââ€â‚¬ââ€â‚¬ SECTION: NEWS PIN/UNPIN ââ€â‚¬ââ€â‚¬ */}
      {activeSection === "news" && (
        <div>
          <div style={S.sectionTitle}>News Pin/Unpin ââ‚¬â€ tabData/news</div>
          <div style={{ fontSize: 12, color: "#64748B", marginBottom: 16 }}>
            ...
            <div key={article.id} style={{
              ...
              <div style={{ flex: 1 }}>
                <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 4 }}>
                  {article.pinned && <span style={{ fontSize: 10, fontWeight: 700, color: "#D4A843", background: "rgba(212,168,67,0.12)", padding: "2px 6px", borderRadius: 4 }}>ğŸâ€œŒ PINNED</span>}
                  <span style={{
                ...
                <div style={{ fontSize: 11, color: "#64748B" }}>
                  {article.source} Â· {article.date} Â· Score: {article.relevanceScore}
                </div>
              </div>
              <button style={S.pinBtn(article.pinned)} onClick={() => togglePin(article.id)}>
                {article.pinned ? "ğŸâ€œŒ Unpin" : "ğŸâ€œ Pin"}
              </button>
            </div>
          ))}
        </div>
