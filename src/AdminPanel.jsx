        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 20 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            ...
            <button type="button" onClick={sendNotification} disabled={notifSending || targetUsers.length === 0}
              ...
              {notifSending ? "Sending..." : `Send Now → ${targetUsers.length} user${targetUsers.length !== 1 ? "s" : ""}`}
            </button>
                ...
                <div key={t.id} style={{ background: T.surfaceAlt, borderRadius: 12, border: `1px solid ${T.border}`, padding: 16 }}>
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 10 }}>
                    ...
                    <div style={{ display: "flex", gap: 4 }}>
                      ...
                      <button type="button" onClick={() => deleteTemplate(t.id)} style={{ padding: "4px 8px", borderRadius: 4, border: `1px solid ${T.red}`, background: "transparent", color: T.red, fontSize: 10, cursor: "pointer" }}>×</button>
                    </div>
                  </div>
