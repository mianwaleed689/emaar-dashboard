...
/* â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
   ...
   Clean Architecture â€” Data-Driven, Firestore-Connected
...
/* â”€â”€â”€ EXTRACTED TAB COMPONENTS â”€â”€â”€ */
...
/* â”€â”€â”€ GLOBAL FILTER CONFIG â”€â”€â”€ */
...
const STATUS_OPTIONS = [
  ...
  { value: "offplan",      label: "Off-Plan â€” Under Construction" },
  { value: "prelaunch",    label: "Off-Plan â€” Pre-Launch / EOI" },
  { value: "ready_new",    label: "Ready â€” New (Primary)" },
  { value: "secondary",    label: "Ready â€” Secondary Market" },
...
/* â”€â”€â”€ SVG ICON HELPER â”€ replaces lucide-react dependency â”€â”€â”€ */
const SvgIcons = {
...
/* â”€â”€â”€ GLOBAL CONTEXT FILTER COMPONENT â”€â”€â”€ */
const GlobalContextFilter = ({
  ...
  // â”€â”€â”€ cleanPhone: strips non-digits â€” NEVER use regex inside JSX â”€â”€â”€
  const cleanPhone = (p) => {
    if (!p) return "";
    let out = "";
  ...
  // â”€â”€â”€ csvEsc: CSV-safe quoting â€” defined here, NOT inside JSX â”€â”€â”€
  const csvEsc = (v) => {
  ...
  /* â•â•â• PREMIUM DROPDOWN STYLE â€” gradient glass surface, subtle shadows â•â•â• */
  const selStyle = {
  ...
  return (
    <div style={{
      ...
      {/* â•â•â• PREMIUM FILTER BAR â€” world-class SaaS aesthetic â•â•â• */}
      <div style={{ padding: "14px 24px" }}>
        {/* ROW 1 â€” Search + Filters + Live indicator */}
        <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
          ...
          {/* Filters button â€” premium pill style */}
          <button
            type="button"
          ...
          {/* Clear all â€” subtle, only when needed */}
          {activeCount > 0 && (
            <button
              type="button"
              onClick={resetAll}
          ...
          {/* Live indicator â€” right aligned, premium */}
          <div style={{
            marginLeft: "auto",
            display: "flex",
            alignItems: "center",
        ...
        {/* ROW 2 â€” Active filter chips (premium pill design) */}
        {activeCount > 0 && (() => {
          const chips = [];
          if (gDeveloper !== "all") {
        ...
        {/* ROW 3 â€” Expandable filter panel (premium card with glass effect) */}
        {open && (
          <div style={{
            marginTop: 14,
            padding: 20,
            ...
            {/* Property Type â€” native select OK for 20 options with optgroups */}
            <div>
            ...
            {/* Community â€” searchable (172 options) */}
            <div>
...
/* â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
   DXB ANALYTICS â€” RESEARCH-BASED SEED DATA
   All figures sourced from official publications â€” listed per dataset
...
const SEED_DATA = {
  ...
  /* â”€â”€â”€ MARKET TAB â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  /* â”€â”€â”€ DLD VOLUMES TAB â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  /* â”€â”€â”€ PRICE HISTORY TAB â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
  priceHistory: [
    /* 5-year PPSF trend â€” Dubai overall apartment average */
  ...
  /* â”€â”€â”€ NEIGHBOURHOODS TAB â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  communities: [
    ...
    { community: "Jumeirah Lake Towers",    avgPpsf: 1420, grossYield: 8.1,  netYield: 6.4, serviceCharge: 16,  metroDistance: 350,  supplyRisk: "Low",    investmentScore: 84, tenantProfile: "Professionals", hasSchool: false, hasMall: true,  hasBeach: false, hasHospital: false, pipeline2026: 1200,  type: "community", isSeedData: true, source: "Middle East Insider Apr 2026 â€” ranked #1 yield+quality" },
    ...
    { community: "Dubai South",             avgPpsf: 850,  grossYield: 8.8,  netYield: 7.2, serviceCharge: 10,  metroDistance: 4000, supplyRisk: "Medium", investmentScore: 73, tenantProfile: "Mixed",         hasSchool: true,  hasMall: false, hasBeach: false, hasHospital: false, pipeline2026: 14000, type: "community", isSeedData: true, source: "uaeexperthub.com Jan 2026 â€” 7.5-9.5% yield range" },
    ...
    { community: "Tilal Al Ghaf",           avgPpsf: 1650, grossYield: 6.8,  netYield: 5.5, serviceCharge: 12,  metroDistance: 5000, supplyRisk: "Low",    investmentScore: 80, tenantProfile: "Families",      hasSchool: true,  hasMall: false, hasBeach: false, hasHospital: false, pipeline2026: 1800,  type: "community", isSeedData: true, source: "DLD 2025 â€” 52% YoY growth" },
    { community: "Discovery Gardens",       avgPpsf: 680,  grossYield: 8.5,  netYield: 7.1, serviceCharge: 9,   metroDistance: 600,  supplyRisk: "Low",    investmentScore: 75, tenantProfile: "Professionals", hasSchool: false, hasMall: true,  hasBeach: false, hasHospital: false, pipeline2026: 400,   type: "community", isSeedData: true, source: "Middle East Insider Apr 2026 â€” 8.5% yield" },
  ...
  /* â”€â”€â”€ LAUNCH CALENDAR TAB â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
  launches: [
    { projectName: "Emaar Grand Polo Club & Resort â€” Phase 2", developer: "Emaar", community: "Dubai Investment South", propertyType: "Villa", status: "EOI Open", launchDate: "2026-04-20", startingPrice: 5700000, totalUnits: 420, paymentPlan: "80/20", eoiAmount: 50000, eoiRefundable: true, launchPrice: 4800, currentPrice: 5200, notes: "Emaar's 60M sqft master plan. Polo fields, 7 clubhouses, equestrian estates. Strong appreciation history on Emaar launches.", type: "launch", isSeedData: true, source: "Alkira Dubai Investment Guide Feb 2026" },
    { projectName: "Dubai Islands â€” Island B Phase 1", developer: "Nakheel", community: "Dubai Islands", propertyType: "Apartment", status: "EOI Open", launchDate: "2026-04-28", startingPrice: 1200000, totalUnits: 680, paymentPlan: "60/40", eoiAmount: 30000, eoiRefundable: true, notes: "Island B offers more controlled planning vs Island A. 24% price growth in 2025. Beachfront value.", type: "launch", isSeedData: true, source: "Alkira Feb 2026 â€” Dubai Islands 24% growth 2025" },
    { projectName: "Sobha Hartland II â€” The Waterfront", developer: "Sobha Realty", community: "Sobha Hartland", propertyType: "Apartment", status: "Upcoming", launchDate: "2026-05-15", startingPrice: 1800000, totalUnits: 520, paymentPlan: "70/30", eoiAmount: 40000, eoiRefundable: true, notes: "High-rise community with green living concept. Sobha known for quality finishes and delivery track record.", type: "launch", isSeedData: true, source: "Arthur Mackenzy Q3 2025 Report" },
    { projectName: "The Oasis by Emaar â€” Phase 11", developer: "Emaar", community: "The Oasis", propertyType: "Villa", status: "Launched", launchDate: "2026-03-10", startingPrice: 6150000, totalUnits: 280, paymentPlan: "80/20 post-handover", eoiAmount: 50000, eoiRefundable: true, launchPrice: 5800, currentPrice: 6300, notes: "10-to-1 scarcity vs Dubai Hills (2,700 units vs 30,000). Lagoon pools, wave pools. Handover Jun 2029.", type: "launch", isSeedData: true, source: "Alkira Feb 2026 â€” 'Blue Lagoon' exclusivity" },
    { projectName: "DAMAC Lagoons â€” Santorini Phase 3", developer: "DAMAC Properties", community: "DAMAC Lagoons", propertyType: "Villa", status: "EOI Closed", launchDate: "2026-03-22", startingPrice: 2200000, totalUnits: 380, paymentPlan: "60/40", eoiAmount: 25000, eoiRefundable: true, notes: "Mediterranean-inspired villas. DAMAC sold out previous phases within hours.", type: "launch", isSeedData: true, source: "Property Finder Launch Radar 2026" },
    { projectName: "Binghatti Skyrise â€” Business Bay", developer: "Binghatti", community: "Business Bay", propertyType: "Apartment", status: "Upcoming", launchDate: "2026-05-08", startingPrice: 850000, totalUnits: 720, paymentPlan: "70/30", eoiAmount: 20000, eoiRefundable: true, notes: "Binghatti's signature bold architecture. Business Bay canal views. Target professional renters â€” strong yield community.", type: "launch", isSeedData: true, source: "Bayut Launch Radar Apr 2026" },
    { projectName: "Tilal Al Ghaf â€” Serenity Mansions", developer: "Majid Al Futtaim", community: "Tilal Al Ghaf", propertyType: "Villa", status: "Sold Out", launchDate: "2026-02-18", startingPrice: 8500000, totalUnits: 85, paymentPlan: "50/50", eoiAmount: 100000, eoiRefundable: false, notes: "Ultra-luxury mansions sold out within 48 hours. DLD 2025 shows 52% YoY transaction growth in Tilal Al Ghaf.", type: "launch", isSeedData: true, source: "DLD 2025 / Bayut 2026" },
    { projectName: "Ellington Ocean House â€” Dubai Islands", developer: "Ellington Properties", community: "Dubai Islands", propertyType: "Apartment", status: "Upcoming", launchDate: "2026-06-01", startingPrice: 2400000, totalUnits: 180, paymentPlan: "70/30", eoiAmount: 50000, eoiRefundable: true, notes: "Design-forward beachfront living. Ellington known for curated interiors. Limited units.", type: "launch", isSeedData: true, source: "Reelly.ai Launch Calendar Apr 2026" },
  ],

  /* â”€â”€â”€ OVERVIEW TAB KPIs â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
     Sources: Same as Market tab
  â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
  overviewKpis: [
    { metric: "Total Market Value",  value: "AED 682.6B",  change: "+21% YoY â€” Full year 2025",   isSeedData: true, source: "DLD / DXB Interact Jan 2026" },
    { metric: "Total Transactions",  value: "215,060",      change: "+19% YoY â€” Sales only",        isSeedData: true, source: "DLD Annual Report 2025" },
    { metric: "Off-Plan Share",      value: "63%",          change: "+3pp â€” Off-plan dominated 2025", isSeedData: true, source: "DLD / Property Monitor 2025" },
    { metric: "Units Launched",      value: "131,504",      change: "532 projects by Oct 2025",     isSeedData: true, source: "DLD Oct 2025" },
  ],
};

/* Seed data source reference â€” shown in UI */
...
/* â”€â”€â”€ TAB GROUPS â”€ 5 sections, 32 tabs in sequence â”€â”€â”€ */
const TAB_GROUPS = [
  {
    id: "market",
...
/* â”€â”€â”€ Flat TABS for backward compatibility â”€â”€â”€ */
...
const css = `
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  /* Native select dropdown dark theming â€” prevents white-background flash on Windows/Linux */
  select option,
  select optgroup {
    ...
    <div style={{ position: "fixed", inset: 0, background: "rgba(4,9,15,0.92)", zIndex: 3000, display: "flex", alignItems: "center", justifyContent: "center", backdropFilter: "blur(12px)", padding: 16 }} onClick={onClose}>
      <div className="upgrade-modal" style={{ background: T.surface, borderRadius: 24, border: `1px solid ${T.border}`, width: "95%", maxWidth: 720, padding: 36, position: "relative", boxShadow: "0 40px 100px rgba(0,0,0,0.6)" }} onClick={e => e.stopPropagation()}>
        ...
        <div style={{ textAlign: "center", display: "flex", justifyContent: "center", gap: 24, flexWrap: "wrap" }}>
          {["\uD83D\uDD12 Secure payment", "â†© 7-day money-back", "âš¡ Instant access", "âŒ Cancel anytime"].map((t, i) => (
...
/* â”€â”€â”€ COMMUNITY MAP TAB â€” moved to tabs/CommunityMapTab.jsx â”€â”€â”€ */
...
const INTELLIGENCE_TABS = {
  ...
  "Portfolio": {
    ...
    adminHint: "Portfolio reads from live market data â€” connect DLD and Bayut first"
  },
  "Competitors": {
    icon: "âš”ï¸",
  ...
  "Map": {
    ...
    adminHint: "Map renders from project data â€” import projects first"
  },
  "Risk": {
    icon: "⚠️",
  ...
  "Currency": {
    icon: "\uD83D\uDCB1",
    description: "Live AED exchange rates for international buyers â€” GBP, USD, EUR, RUB, INR, CNY, and more. Property price converter and historical rate chart.",
  ...
  "Flip": {
    icon: "\uD83D\uDD04",
    description: "Property flip ROI calculator â€” purchase price, renovation cost, holding period, selling price. Returns net profit, ROI, annualised return, and optimal hold period.",
    adminHint: "Flip calculator works with market data â€” connect DLD and Bayut first"
  },
  "Investment Score": {
    icon: "⭐",
    description: "AI investment scoring for any property â€” yield potential, location quality, developer health, price vs market, liquidity, handover risk, supply risk. 0-100 score with breakdown.",
    adminHint: "Investment Score requires project data â€” import projects first"
  },
  "Price History": {
    icon: "\uD83D\uDCC9",
  ...
  render() {
    if (this.state.hasError) return (
      <div style={{ padding:"60px 24px", textAlign:"center" }}>
        ...
        <div style={{ fontSize:11, color:"#6B7280", marginTop:10 }}>All other tabs remain accessible â€” use the sidebar to navigate</div>
      </div>
    );
...
export default function EmaarDashboardV2() {
  ...
  /* â”€â”€â”€ Tab persistence: restore on load + back/forward â”€â”€â”€ */
  useEffect(() => {
    try {
  ...
  /* â”€â”€â”€ GLOBAL CONTEXT FILTER STATE â”€â”€â”€ */
  /* Phase 2.3: filters now live in the URL via useFilters().
     The g* names below are compatibility shims â€” they read from the URL
  ...
  /* â”€â”€â”€ PRICE HISTORY TAB STATE â”€â”€â”€ */
  ...
  /* â”€â”€â”€ HANDOVER STATUS + RISK CONFIG â€” top level (used by tab + overlay) â”€â”€â”€ */
  const statusCfg = {
  ...
  /* â”€â”€â”€ MY LEADS STATE (Session 4) â”€â”€â”€ */
  const [myLeads, setMyLeads] = useState([]);
  const [myLeadsLoading, setMyLeadsLoading] = useState(false);

  /* â”€â”€â”€ DEAL PIPELINE STATE (Session 5) â”€â”€â”€ */
  const [deals, setDeals] = useState([]);

  /* â”€â”€â”€ MANAGER DASHBOARD STATE (Session 7) â”€â”€â”€ */
  const [teamMembers, setTeamMembers] = useState([]);
  const [teamMembersLoading, setTeamMembersLoading] = useState(false);

  /* â”€â”€â”€ AGENCY HUB STATE (Session 8) â”€â”€â”€ */
  ...
  /* â”€â”€â”€ INTELLIGENCE STATE (Session 12) â”€â”€â”€ */
  ...
  /* â”€â”€â”€ DLD LIVE INTELLIGENCE STATE (Session 15) â”€â”€â”€ */
  ...
  /* â”€â”€â”€ BULK IMPORT STATE (Session 16) â”€â”€â”€ */
  ...
  /* â”€â”€â”€ DLD AUTO-REFRESH (Session 15) â”€â”€â”€ */
  React.useEffect(() => {
  ...
  /* â”€â”€â”€ DEV PORTAL STATE (Session 10) â”€â”€â”€ */
  ...
  /* â”€â”€â”€ LISTINGS STATE (Session 9) â”€â”€â”€ */
  ...
  /* â”€â”€â”€ COMPLIANCE STATE (Session 6) â”€â”€â”€ */
  ...
  /* â”€â”€â”€ MY LEADS MISSING STATE (V11) â”€â”€â”€ */

  /* â”€â”€â”€ V12 NEW STATE â”€â”€â”€ */
  ...
  /* â”€â”€â”€ MY LEADS ADDITIONAL STATE â”€â”€â”€ */
  ...
  /* â”€â”€â”€ COMPETITORS TAB STATE â”€â”€â”€ */
  ...
  /* â”€â”€â”€ MARKETING INTELLIGENCE TAB STATE â”€â”€â”€ */
  ...
  /* â”€â”€â”€ MORTGAGE LEAD CAPTURE STATE â”€â”€â”€ */
  ...
  /* â”€â”€â”€ BANKING INTELLIGENCE TAB STATE â”€â”€â”€ */
  ...
  /* â”€â”€â”€ DEVELOPER HEALTH TAB STATE â”€â”€â”€ */
  ...
  /* â”€â”€â”€ FINANCIALS TAB STATE â”€â”€â”€ */
  ...
  /* â”€â”€â”€ GOLDEN VISA TAB STATE â”€â”€â”€ */
  ...
  /* â”€â”€â”€ DXB ESTIMATE (AVM) STATE â”€â”€â”€ */
  ...
  /* â”€â”€â”€ FLIP CALCULATOR ADDITIONAL STATE â”€â”€â”€ */
  ...
  /* â”€â”€â”€ INVESTMENT SCORE TAB STATE â”€â”€â”€ */
  ...
  /* â”€â”€â”€ MORTGAGE TAB STATE â”€â”€â”€ */
  ...
  /* â”€â”€â”€ STR vs LTR TAB STATE â”€â”€â”€ */
  ...
  /* â”€â”€â”€ LAUNCH CALENDAR STATE â”€â”€â”€ */
  ...
  /* â”€â”€â”€ NEIGHBOURHOODS STATE â”€â”€â”€ */
  ...
  /* â”€â”€â”€ PROJECTS TAB FILTER STATE â”€â”€â”€ */
  ...
  /* â”€â”€â”€ PROJECT MODAL STATE â”€â”€â”€ */
  ...
  /* â”€â”€â”€ SERVICE CHARGES TAB STATE â”€â”€â”€ */
  ...
  /* â”€â”€â”€ HANDOVER TAB STATE â”€â”€â”€ */
  /* â”€â”€â”€ HANDOVER DETAIL VIEW STATE â”€â”€â”€ */
  ...
  const SEED_PROJECTS = [
    {
      /* â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
         GOLF GRAND â€” VERIFIED TEMPLATE PROJECT (v17)
      ...
      /* â”€â”€â”€ DEVELOPER (per DLD Mashrooi â€” project sold by JV entity) â”€â”€â”€ */
      ...
      /* â”€â”€â”€ LOCATION (verified from Emaar official + Bayut area guide + apilproperties) â”€â”€â”€ */
      coordinates: { lat: 25.1058, lng: 55.2486 },  /* DHE Golf Grand approx location */
      distMetro: 8,                       /* ~11 min drive to ONPASSIVE Metro (per Bayut) */
      distDIFC: 15,                        /* Per Emaar â€” 15 min = ~15km to Downtown/DIFC area */
      distAirport: 24,                     /* DXB â€” verified from Emaar/apilproperties */
      ...
      reraRegistered: true,
      escrowBank: "Verify via DLD Mashrooi",  /* Honest â€” Emaar uses multiple banks; confirm per project on DLD app */
      escrowAccount: null,
      ...
      /* â”€â”€â”€ INVESTMENT METRICS (no arbitrary scores) â”€â”€â”€ */
      commission: 2.0,                   /* Standard broker commission â€” industry norm */
      /* investmentScore / velocityScore / developerScore removed â€” they were arbitrary opinions, not data */
  ...
  const toggleCompare = (p) => {
    setCompareList(prev => {
      ...
      notify("âœ… Added " + p.name + " to comparison");
      return [...prev, p];
    });
  };
  ...
  useEffect(() => {
    ...
    // developments collection â€” 2,798 DLD-sourced records (imported via admin)
    ...
    /* â”€â”€â”€ PORTFOLIO (user-specific) â”€â”€â”€ */
    ...
    /* â”€â”€â”€ ALL LEADS (admin/general view) â”€â”€â”€ */
    if (auth.currentUser?.uid) {
      unsubs.push(onSnapshot(
...
return () => unsubs.forEach(u => { try { u(); } catch {} });
  ...
  /* â”€â”€â”€ MY LEADS LISTENER (Session 4) â”€â”€â”€ */
  useEffect(() => {
  ...
  /* â”€â”€â”€ DEALS PIPELINE LISTENER (Session 5) â”€â”€â”€ */
  useEffect(() => {
    if (!isLoggedIn || !firebaseUser) return;
    const isAgent   = orgRole === "agent";
    const isManager = orgRole === "manager";
  ...
  /* â”€â”€â”€ TEAM MEMBERS LISTENER (Session 7) â”€â”€â”€ */
  useEffect(() => {
  ...
  /* â”€â”€â”€ ORG PROFILE LISTENER (Session 8) â”€â”€â”€ */
  useEffect(() => {
    if (!isLoggedIn || !firebaseUser || orgRole !== "manager" || !orgId) return;
  ...
  /* â”€â”€â”€ LISTINGS LISTENER (Session 9) â”€â”€â”€ */
  useEffect(() => {
    if (!isLoggedIn || !firebaseUser) return;
    const isAgent   = orgRole === "agent";
    const isManager = orgRole === "manager";
  ...
  /* â”€â”€â”€ DEV PORTAL LISTENERS (Session 10) â”€â”€â”€ */
  useEffect(() => {
  ...
  /* â”€â”€â”€ RERA CARD READER (Session 6) â”€â”€â”€ */
  useEffect(() => {
    if (!isLoggedIn || !firebaseUser) return;
  ...
  const saveAlerts = async (alerts) => {
    setMyAlerts(alerts);
    if (auth.currentUser) {
      await safeAsyncWithToast(() => setDoc(doc(db, "priceAlerts", auth.currentUser.uid), { alerts, updatedAt: new Date().toISOString() }), "price-alerts-save", notify, "Couldn't save your price alerts â€” try again");
    }
  };
    ...
    <div style={{ minHeight: "100vh", background: T.bg, fontFamily: "'Outfit', sans-serif" }}>
      ...
      <main role="main" id="main-content" className="main-content" style={{ marginLeft: 240, paddingTop: userTier === "free" ? 210 : 180, minHeight: "100vh", overflowX: "hidden" }}>
        ...
        <div style={{ padding: `0 24px ${compareList.length > 0 && tab === "Projects" ? "120px" : "60px"}` }}>
          ...
          {/* â”€â”€â”€ MARKET TAB (extracted) â”€â”€â”€ */}
          {tab === "Market" && (
            <MarketTab
          ...
          {/* â”€â”€â”€ DLD VOLUMES TAB â”€â”€â”€ */}
          {/* â”€â”€â”€ DLD VOLUMES TAB (extracted) â”€â”€â”€ */}
          {tab === "DLD Volumes" && (
            <DLDVolumesTab
          ...
          {/* â”€â”€â”€ PRICE HISTORY TAB (extracted) â”€â”€â”€ */}
          {tab === "Price History" && (
            <PriceHistoryTab
          ...
          {/* â”€â”€â”€ NEIGHBOURHOODS TAB (extracted) â”€â”€â”€ */}
          {tab === "Neighbourhoods" && (
            <NeighbourhoodsTab
          ...
          {/* â”€â”€â”€ LAUNCH CALENDAR TAB (extracted) â”€â”€â”€ */}
          {tab === "Launch Calendar" && (
            <LaunchCalendarTab
          ...
          {/* â”€â”€â”€ CURRENCY TAB â”€â”€â”€ */}
          {/* â”€â”€â”€ CURRENCY TAB (extracted) â”€â”€â”€ */}
          {tab === "Currency" && (
            <CurrencyTab
          ...
          {/* â•â•â• HANDOVER DETAIL OVERLAY â•â•â• */}
          {hvSelected && (
            <div role="dialog" aria-modal="true" style={{ position:"fixed", inset:0, background:"rgba(4,9,15,0.97)", zIndex:2000, display:"flex", flexDirection:"column", backdropFilter:"blur(8px)" }}>
              ...
              <div style={{ display:"flex", alignItems:"center", justifyContent:"space-between", padding:"16px 24px", borderBottom:`1px solid ${T.border}`, background:T.surface, flexShrink:0 }}>
                ...
                <div style={{ display:"flex", alignItems:"center", gap:10 }}>
                  ...
                  <button type="button" onClick={() => setHvSelected(null)} style={{ width:36, height:36, borderRadius:"50%", background:T.surfaceAlt, border:`1px solid ${T.border}`, color:T.white, cursor:"pointer", display:"flex", alignItems:"center", justifyContent:"center", fontSize:18, fontFamily:"'Outfit',sans-serif" }}>Ã—</button>
                </div>
              </div>
                ...
                <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:12, marginBottom:16 }}>
                  <div className="chart-box" style={{ padding:18 }}>
                    ...
                    {[
                      ...
                      { label:"Last Site Visit",  value:hvSelected.lastSiteVisit ? new Date(hvSelected.lastSiteVisit).toLocaleDateString("en-GB") : "â€”" },
                    ].map((r,i) => (
                      <div key={i} style={{ display:"flex", justifyContent:"space-between", padding:"6px 0", borderBottom:i<3?`1px solid ${T.border}`:"none" }}>
                        ...
                        <span style={{ fontSize:11, fontWeight:600, color:T.white }}>{r.value||"â€”"}</span>
                      </div>
                    ))}
                  </div>
                  <div className="chart-box" style={{ padding:18 }}>
          ...
          {/* â”€â”€â”€ HANDOVER TAB â”€â”€â”€ */}
          {/* â”€â”€â”€ HANDOVER TAB (extracted to tabs/HandoverTab.jsx) â”€â”€â”€ */}
          {tab === "Handover" && (
            <HandoverTab
              ...
              <div style={{ display:"flex", alignItems:"center", justifyContent:"space-between", padding:"16px 24px", borderBottom:`1px solid ${T.border}`, background:T.surface, flexShrink:0 }}>
                ...
                <div style={{ display:"flex", alignItems:"center", gap:12 }}>
                  ...
                  <button type="button" onClick={() => setHdvSelected(null)}
                    style={{ width:36, height:36, borderRadius:"50%", background:T.surfaceAlt, border:`1px solid ${T.border}`, color:T.white, cursor:"pointer", display:"flex", alignItems:"center", justifyContent:"center", fontSize:18, fontFamily:"'Outfit',sans-serif" }}>Ã—</button>
                </div>
              </div>
              {/* Overlay content */}
              <div style={{ flex:1, overflowY:"auto", padding:24 }}>
                ...
                <div className="chart-box" style={{ padding:20, marginBottom:16 }}>
                  <div style={{ fontSize:13, fontWeight:700, color:T.white, marginBottom:16 }}>Construction Milestones â€” RERA Verified</div>
          ...
          {/* â”€â”€â”€ SERVICE CHARGES TAB (extracted) â”€â”€â”€ */}
          {tab === "Service Charges" && (
            <ServiceChargesTab
          ...
          {/* â”€â”€â”€ YIELDS TAB (extracted) â”€â”€â”€ */}
          {tab === "Yields" && (
            <YieldsTab
          ...
          {/* â”€â”€â”€ STR vs LTR TAB â”€â”€â”€ */}
          {/* â”€â”€â”€ STR vs LTR TAB (extracted) â”€â”€â”€ */}
          {tab === "STR vs LTR" && (
            <STRvsLTRTab
          ...
          {/* â”€â”€â”€ MORTGAGE TAB â”€â”€â”€ */}
          {/* â”€â”€â”€ MORTGAGE TAB (extracted) â”€â”€â”€ */}
          {tab === "Mortgage" && (
            <MortgageTab
          ...
          {/* â”€â”€â”€ INVESTMENT SCORE TAB (extracted) â”€â”€â”€ */}
          ...
          {/* â”€â”€â”€ FLIP CALCULATOR TAB â”€â”€â”€ */}
          {/* â”€â”€â”€ FLIP TAB (extracted) â”€â”€â”€ */}
          {tab === "Flip" && (
            <FlipTab
          ...
          {/* â”€â”€â”€ DXB ESTIMATE TAB â”€â”€â”€ */}
          {/* â”€â”€â”€ DXB ESTIMATE TAB (extracted) â”€â”€â”€ */}
          {tab === "DXB Estimate" && (
            <DXBEstimateTab
          ...
          {/* â”€â”€â”€ PORTFOLIO TAB (extracted) â”€â”€â”€ */}
          {tab === "Portfolio" && (
            <PortfolioTab
          ...
          {/* â”€â”€â”€ GOLDEN VISA TAB (extracted) â”€â”€â”€ */}
          {tab === "Golden Visa" && (
            <GoldenVisaTab
          ...
          {/* â”€â”€â”€ RISK TAB (extracted) â”€â”€â”€ */}
          {tab === "Risk" && (
            <RiskTab
          ...
          {/* â”€â”€â”€ DEVELOPER HEALTH TAB â”€â”€â”€ */}
          ...
          {/* â”€â”€â”€ BANKING INTELLIGENCE TAB â”€â”€â”€ */}
          ...
          {/* â”€â”€â”€ MARKETING INTELLIGENCE TAB â”€â”€â”€ */}
          ...
          {/* â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
              MY LEADS TAB â€” Session 4 â€” Agent CRM Inbox
          â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• */}
          ...
          {/* â”€â”€â”€ PIPELINE TAB (extracted) â”€â”€â”€ */}
          {tab === "Pipeline" && (
            <PipelineTab
          ...
          {/* â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
              COMPLIANCE TAB â€” Session 6
              RERA card tracker + WhatsApp templates
          â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• */}
          {/* â”€â”€â”€ COMPLIANCE TAB (extracted) â”€â”€â”€ */}
          {tab === "Compliance" && (
            <ComplianceTab
          ...
          <div style={{ padding: "20px 28px" }}>
            ...
            <div style={{ background: T.surfaceAlt, borderRadius: 14, padding: 18, border: `1px solid ${T.border}`, marginBottom: 20 }}>
              ...
              <button type="button" disabled={alertSaving} onClick={async () => {
                ...
                setMyAlerts(updated);
                await safeAsyncWithToast(() => setDoc(doc(db, "priceAlerts", user), { alerts: updated, updatedAt: new Date().toISOString() }), "price-alert-add", notify, "Couldn't save your new price alert â€” try again");
            ...
            {myAlerts.map((a, i) => (
              <div key={a.id || i} style={{ display: "flex", alignItems: "center", gap: 12, padding: "12px 14px", background: T.surfaceAlt, borderRadius: 10, border: `1px solid ${T.border}`, marginBottom: 8 }}>
                ...
                <button type="button" onClick={async () => {
                  ...
                  setMyAlerts(updated);
                  await safeAsyncWithToast(() => setDoc(doc(db, "priceAlerts", user), { alerts: updated, updatedAt: new Date().toISOString() }), "price-alert-delete", notify, "Couldn't remove the price alert â€” try again");
          ...
          <div style={{ padding: "32px 28px 20px", background: `linear-gradient(135deg, rgba(212,168,67,0.08), rgba(14,29,53,0.6))`, borderBottom: `1px solid ${T.border}` }}>
            <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
              ...
              <div>
                ...
                <div style={{ display: "inline-flex", alignItems: "center", gap: 4, marginTop: 6, padding: "3px 10px", borderRadius: 6, background: userTier === "admin" || userTier === "pro" || userTier === "enterprise" ? "rgba(16,185,129,0.12)" : userTier === "pro_trial" ? "rgba(212,168,67,0.12)" : "rgba(59,130,246,0.12)", fontSize: 10, fontWeight: 700, color: userTier === "admin" || userTier === "pro" || userTier === "enterprise" ? T.green : userTier === "pro_trial" ? T.gold : T.blue }}>{userTier === "admin" ? "âš¡ Admin" : userTier === "pro" ? "⭐ Pro Plan" : userTier === "pro_trial" ? `⭐ Pro Trial · ${trialDaysLeft}d left` : userTier === "enterprise" ? "\uD83C\uDFE2 Enterprise" : "Free Plan"}</div>
              </div>
            </div>
          </div>
          <div style={{ padding: "20px 28px 28px" }}>
            <div style={{ marginBottom: 20 }}>
              ...
              <button type="button" onClick={async () => { if (auth.currentUser && profileEdit.name.trim()) { try { await setDoc(doc(db, "users", auth.currentUser.uid), { name: profileEdit.name.trim() }, { merge: true }); setUserName(profileEdit.name.trim()); setToast("âœ… Profile updated!"); setTimeout(() => setToast(""), 3000); } catch(e) { setToast("âŒ Update failed"); setTimeout(() => setToast(""), 3000); } } }} style={{ marginTop: 10, padding: "8px 20px", background: T.gold, color: T.bg, border: "none", borderRadius: 8, fontWeight: 700, fontSize: 12, cursor: "pointer", fontFamily: "'Outfit', sans-serif" }}>Save Changes</button>
            </div>
            <div style={{ marginBottom: 20, padding: 16, borderRadius: 12, background: T.surfaceAlt, border: `1px solid ${T.border}` }}>
              ...
              {(userTier === "free" || userTier === "pro_trial") && <button type="button" onClick={() => { setShowProfile(false); setShowUpgrade(true); }} style={{ marginTop: 12, width: "100%", padding: "10px 0", background: `linear-gradient(135deg, ${T.gold}, #B8912F)`, color: T.bg, border: "none", borderRadius: 8, fontWeight: 700, fontSize: 13, cursor: "pointer", fontFamily: "'Outfit', sans-serif" }}>{userTier === "pro_trial" ? "Subscribe Before Trial Ends" : "⭐ Upgrade to Pro â€” AED 99/mo"}</button>}
            </div>
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10 }}>
