/**
 * DXB ANALYTICS ‚‚Ç¨‚Äù useProjectContext HOOK
 * ========================================
 ...
 *             <button onClick={clearContext}>‚ú‚Ä¢ Clear</button>
 *           </div>
 *         )}
 *         ...rest of tab...
 *       </div>
...
/**
 * Context banner component ‚‚Ç¨‚Äù shown at top of tab when project context is active
...
export const STATE_DECLARATIONS = `
  // Project context ‚‚Ç¨‚Äù set when user clicks action button on a project card
