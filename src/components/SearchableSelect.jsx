/* eslint-disable */
/* ════════════════════════════════════════════════════════════════
   SearchableSelect — premium custom dropdown for large option lists
   Replaces native HTML <select> when you have 20+ options.
   
   Features:
   - Type to search (substring match on label)
   - Keyboard nav: ↑/↓ to move, ⏎ to select, ␛ to close
...
export default function SearchableSelect({
  ...
  /* Trigger button styling — premium pill */
  const triggerStyle = {
    width,
      ...
      {open && rect && typeof document !== "undefined" && createPortal(
        ...
        >
          ...
          <div style={{
            ...
            <span style={{ opacity: 0.6 }}>↑↓ nav · ⏎ select · ␛ close</span>
          </div>
        </div>,
        document.body
      )}
