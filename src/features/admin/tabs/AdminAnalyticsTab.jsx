...
import {
  AreaChart, BarChart, CartesianGrid, XAxis, YAxis,
  Tooltip, Area, Bar, Line, ResponsiveContainer
} from "recharts";

/* ════════════════════════════════════════════════════════════════
   AdminAnalyticsTab — extracted from AdminPanel.jsx (Session 23 fix)
   Props: T, I, users, auditLog, mrr, arr, stats, now,
          analyticsRange, setAnalyticsRange, setTab, setPendingOpenUid, notify
════════════════════════════════════════════════════════════════ */
