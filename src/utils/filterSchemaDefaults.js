/* eslint-disable */
/**
 * DXB Analytics ‚‚Ç¨‚Äù Filter Schema Defaults
 * =========================================
 *
 ...
 * the FilterSchemaContext falls back to these defaults ‚‚Ç¨‚Äù guaranteeing the
 * platform always boots.
 *
 * To change the canonical lists: edit the Admin panel ‚Ü‚Äô Platform Settings.
