      ...
      <main role="main" id="main-content" className="main-content" style={{ marginLeft: 240, paddingTop: userTier === "free" ? 140 : 100, minHeight: "100vh", overflowX: "hidden" }}>
        ...
        <div style={{ padding: `0 24px ${compareList.length > 0 && tab === "Projects" ? "120px" : "60px"}` }}>
          ...
          {tab === "Currency" && (() => {
            ...
            const chartData = (RATE_HISTORY[selectedCcy] || RATE_HISTORY.GBP).map((rate, i) => ({
              month: MONTHS[i], rate
            }));

            const filteredCcys = TOP_CURRENCIES.filter(c =>
              c.name.toLowerCase().includes(searchCcy.toLowerCase()) ||
              c.code.toLowerCase().includes(searchCcy.toLowerCase())
            );
                  ...
                  <div className="chart-box" style={{ padding: 20 }}>
                    ...
                    <div style={{ marginBottom: 16 }}>
                      ...
                      <input
                        type="number"
                        value={aedAmount}
                        onChange={e => setAedAmount(parseFloat(e.target.value) || 0)}
                    ...
                    {/* Result */}
                    <div style={{ padding: "16px", background: "rgba(212,168,67,0.06)", borderRadius: 10, border: `1px solid rgba(212,168,67,0.2)`, textAlign: "center" }}>
                      <div style={{ fontSize: 11, color: T.textMuted, marginBottom: 6 }}>AED {aedAmount.toLocaleString()} =</div>
                      <div style={{ fontFamily: "'Fraunces', serif", fontSize: 32, fontWeight: 900, color: T.gold }}>
                        {selectedCcy} {convertedAmount}
                      </div>
                      <div style={{ fontSize: 11, color: T.textMuted, marginTop: 6 }}>
                        Rate: 1 AED = {selectedRate.toFixed(4)} {selectedCcy}
                      </div>
                      {aedAmount >= 2000000 && (
                        <div style={{ marginTop: 10, padding: "4px 12px", borderRadius: 20, background: "rgba(16,185,129,0.1)", border: "1px solid rgba(16,185,129,0.2)", color: T.green, fontSize: 11, fontWeight: 700, display: "inline-block" }}>
                  ...
                  <div className="chart-box" style={{ padding: 20 }}>
                    ...
                    <ResponsiveContainer width="100%" height={220}>
                      <AreaChart data={chartData}>
                        <defs>
                          <linearGradient id="ccyGold" x1="0" y1="0" x2="0" y2="1">
                            <stop offset="5%" stopColor={T.gold} stopOpacity={0.2}/>
                            <stop offset="95%" stopColor={T.gold} stopOpacity={0}/>
                          </linearGradient>
                        </defs>
                        ...
                        <YAxis tick={{ fill: T.textMuted, fontSize: 11 }} axisLine={false} tickLine={false}
                          tickFormatter={v => v.toFixed(selectedRate < 1 ? 4 : 2)} width={60} />
                        <Tooltip contentStyle={{ background: T.surface, border: `1px solid ${T.border}`, borderRadius: 10 }}
                          labelStyle={{ color: T.white }} itemStyle={{ color: T.gold }}
                          formatter={v => [v.toFixed(selectedRate < 1 ? 4 : 4) + " " + selectedCcy, "Rate"]} />
                    ...
                    {filteredCcys.map((c, i) => (
                      <div key={i} onClick={() => setSelectedCcy(c.code)}
                        ...
                        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                          ...
                          <span style={{ fontSize: 13, color: T.white, fontWeight: 500 }}>{c.name}</span>
                        </div>
                        <div style={{ fontSize: 13, color: T.textMuted, fontWeight: 600 }}>{c.code}</div>
                        <div style={{ fontSize: 13, color: T.gold, fontWeight: 700 }}>{c.rate.toFixed(c.rate < 1 ? 4 : 4)}</div>
                        <div style={{ fontSize: 12, color: c.change > 0 ? T.green : c.change < 0 ? T.red : T.textMuted, fontWeight: 600 }}>
          ...
          {tab === "Projects" && (() => {
            ...
            const SEED_PROJECTS = [
              { id:"p001", type:"Apartment", developer:"Emaar", project:"Golf Grand — Phase 2", community:"Dubai Hills Estate", status:"Off-Plan", handover:"Q4 2027", beds:["1BR","2BR","3BR"], sizeMin:748, sizeMax:1842, priceMin:1200000, priceMax:3800000, ppsf:1850,
                unitBreakdown:[
              ...
              { id:"p002", type:"Apartment", developer:"DAMAC Properties", project:"Lagoons — Azure Beach", community:"DAMAC Lagoons", status:"Off-Plan", handover:"Q2 2027", beds:["Studio","1BR","2BR"], sizeMin:420, sizeMax:1240, priceMin:680000, priceMax:2100000, ppsf:1420,
                unitBreakdown:[
              ...
              { id:"p003", type:"Apartment", developer:"Sobha Realty", project:"Hartland II — Skyvista", community:"Sobha Hartland", status:"Off-Plan", handover:"Q3 2027", beds:["1BR","2BR","3BR","4BR"], sizeMin:780, sizeMax:2800, priceMin:1800000, priceMax:6500000, ppsf:2100,
                unitBreakdown:[
              ...
              { id:"p004", type:"Apartment", developer:"Binghatti", project:"Skyrise — Business Bay", community:"Business Bay", status:"Off-Plan", handover:"Q1 2027", beds:["Studio","1BR","2BR"], sizeMin:380, sizeMax:1050, priceMin:750000, priceMax:2200000, ppsf:1980,
                unitBreakdown:[
              ...
              { id:"p005", type:"Apartment", developer:"Ellington Properties", project:"Ocean House", community:"Dubai Islands", status:"Off-Plan", handover:"Q2 2026", beds:["1BR","2BR","3BR","4BR"], sizeMin:920, sizeMax:4200, priceMin:2400000, priceMax:18000000, ppsf:2800,
                unitBreakdown:[
              ...
              { id:"p006", type:"Villa", developer:"Emaar", project:"The Oasis — Phase 11", community:"The Oasis", status:"Off-Plan", handover:"Q2 2029", beds:["4BR","5BR","6BR"], sizeMin:5800, sizeMax:14000, priceMin:6150000, priceMax:32000000, ppsf:1480,
                unitBreakdown:[
              ...
              { id:"p008", type:"Townhouse", developer:"Nakheel", project:"Dubai Islands — Cluster B", community:"Dubai Islands", status:"Off-Plan", handover:"Q4 2027", beds:["3BR","4BR"], sizeMin:2200, sizeMax:3800, priceMin:3200000, priceMax:6500000, ppsf:1620,
                unitBreakdown:[
              ...
              { id:"p009", type:"Hotel Apartment", developer:"Omniyat", project:"Orla Infinity", community:"Palm Jumeirah", status:"Off-Plan", handover:"Q4 2027", beds:["Studio","1BR","2BR","3BR"], sizeMin:800, sizeMax:6500, priceMin:4500000, priceMax:65000000, ppsf:4800,
                unitBreakdown:[
