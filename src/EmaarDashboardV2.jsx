...
export default function EmaarDashboardV2() {
  ...
  const SEED_PROJECTS = [
    { id:"p001", tier:1, goldenVisa:true, appreciationToHandover:32, branded:false, velocityScore:86, commission:2.0, type:"Apartment", developer:"Emaar", project:"Golf Grand â€” Phase 2", community:"Dubai Hills Estate", status:"Off-Plan", handover:"Q4 2027", beds:["1BR","2BR","3BR"], sizeMin:748, sizeMax:1842, priceMin:1200000, priceMax:3800000, ppsf:1850,
      unitBreakdown:[
    ...
    { id:"p003", tier:1, goldenVisa:true, appreciationToHandover:33, branded:false, velocityScore:89, commission:2.0, type:"Apartment", developer:"Sobha Realty", project:"Hartland II â€” Skyvista", community:"Sobha Hartland", status:"Off-Plan", handover:"Q3 2027", beds:["1BR","2BR","3BR","4BR"], sizeMin:780, sizeMax:2800, priceMin:1800000, priceMax:6500000, ppsf:2100,
      unitBreakdown:[
    ...
    { id:"p006", tier:1, goldenVisa:true, appreciationToHandover:38, branded:false, velocityScore:88, commission:2.0, type:"Villa", developer:"Emaar", project:"The Oasis â€” Phase 11", community:"The Oasis", status:"Off-Plan", handover:"Q2 2029", beds:["4BR","5BR","6BR"], sizeMin:5800, sizeMax:14000, priceMin:6150000, priceMax:32000000, ppsf:1480,
      unitBreakdown:[
    ...
    { id:"p008", tier:1, goldenVisa:true, appreciationToHandover:32, branded:false, velocityScore:84, commission:2.0, type:"Townhouse", developer:"Nakheel", project:"Dubai Islands â€” Cluster B", community:"Dubai Islands", status:"Off-Plan", handover:"Q4 2027", beds:["3BR","4BR"], sizeMin:2200, sizeMax:3800, priceMin:3200000, priceMax:6500000, ppsf:1620,
      unitBreakdown:[
        ...
        <div style={{ background: T.surface, borderRadius: 20, border: `1px solid ${T.border}`, width: "95%", maxWidth: 560, maxHeight: "90vh", overflow: "auto", position: "relative" }} onClick={e => e.stopPropagation()}>
          ...
          <div style={{ padding: "20px 28px 28px" }}>
            ...
            <div style={{ marginBottom: 20, padding: 16, borderRadius: 12, background: T.surfaceAlt, border: `1px solid ${T.border}` }}>
              ...
              {(userTier === "free" || userTier === "pro_trial") && <button type="button" onClick={() => { setShowProfile(false); setShowUpgrade(true); }} style={{ marginTop: 12, width: "100%", padding: "10px 0", background: `linear-gradient(135deg, ${T.gold}, #B8912F)`, color: T.bg, border: "none", borderRadius: 8, fontWeight: 700, fontSize: 13, cursor: "pointer", fontFamily: "'Outfit', sans-serif" }}>{userTier === "pro_trial" ? "Subscribe Before Trial Ends" : "â­ Upgrade to Pro â€” AED 99/mo"}</button>}
            </div>
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10 }}>
